document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadAllResponses() {
        ...
        // This function will be implemented to show all responses
    }
    ...
    // Global functions for call management
    window.editUserCall = function(callId) {
        // This will be implemented to fetch call data and show edit modal
        console.log('Edit call:', callId);
    };

    window.triggerCall = function(callId) {
        triggerUserCall(callId);
    };

    // Function to render user reports
    ...
    function viewResponseDetails(responseId) {
        console.log('🔍 Viewing response details for ID:', responseId);
        // This function will be implemented to show detailed response modal
    }
